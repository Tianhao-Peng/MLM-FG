...
def get_parser(parser=None):
    ...
    parser.add_argument('--checkpoint_every',
                           ...
                           help='save checkpoint every x iterations/batch')
    parser.add_argument('--every_n_epochs',
                           type=int, default=1,
                           help='save checkpoint every x epoch')
   ...
   # resume_arg = parser.add_argument_group('Resume')
    ...
    parser.add_argument('--target_list', type=list, default=None)
    parser.add_argument('--splitting', type=str, default=None)
    parser.add_argument('--resume_from_checkpoint', type=str, default=None)
    parser.add_argument('--balance_training_dataset', type=str, default='False')
    ...
    parser.add_argument("--results_path", type=str, required=False, default='merged_results.csv')
    parser.add_argument("--aug_training_dataset", type=str, required=True, default='False')
    parser.add_argument("--unfreeze", type=int, required=True, default=-1)
    parser.add_argument("--freeze", type=str, required=True, default='True')
    parser.add_argument("--graph_padding", type=str, required=True, default='.')
    parser.add_argument("--pos_type", type=str, required=True, default='.')
